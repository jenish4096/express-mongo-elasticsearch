...
module.exports = {
  ...
  createEmployees: {
    body: {
      ...
      gender: Joi.string().optional().allow('').label('Gender').valid('Female', 'Male').default('Male'),
      age: Joi.string().optional().allow('').label('Age'),
      maritalStatus: Joi.string().optional().label('Marital Status').valid('Unmarried', 'Married').default('Unmarried')
    },
  },
  ...
  listEmployees: {
    body: {
      term: Joi.string().optional().allow('').empty().trim().label('Searching term'),
